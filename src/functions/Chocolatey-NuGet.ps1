...
Write-Debug "Installing packages to `"$nugetLibPath`"."
  ...
  foreach ($line in $nugetOutput) {
    ...
    if ($line -notlike "*not installed*" -and ($line -notlike "*already installed*" -or $force -eq $true) -and $line -notlike "Attempting to resolve dependency*" -and $line -notlike "*installing*") {
